 ...
 * {@link ru.irafa.conversation.adapter.ConversationAdapter#VIEW_TYPE_SELF}.
 * Created by Raphael Gilyazitdinov on 06.08.16.
 */

public class ConversationViewHolderSelf extends BaseConversationViewHolder {

    private final ItemConversationRightBinding mBinding;

    public ConversationViewHolderSelf(Context context, ItemConversationRightBinding binding) {
