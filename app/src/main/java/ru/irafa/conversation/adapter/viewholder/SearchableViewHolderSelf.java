 ...
 * {@link ConversationSearchableAdapter#VIEW_TYPE_SELF}.
 * Created by Raphael Gilyazitdinov on 06.08.16.
 */

public class SearchableViewHolderSelf extends BaseSearchableViewHolder<Message> {

    private final ItemConversationRightBinding mBinding;

    public SearchableViewHolderSelf(Context context, ItemConversationRightBinding binding) {
    ...
    public void bind(Message data, boolean foundInSearch, @Nullable String searchQuery) {
        ...
        if (foundInSearch) {
            ...
            mBinding.messageItem.setSelected(true);
        }else {
            mBinding.messageItem.setSelected(false);
        }
    }
